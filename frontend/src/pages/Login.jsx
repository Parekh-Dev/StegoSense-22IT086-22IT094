...
const Login = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    setError("")
    try {
      const res = await axios.post(API_ENDPOINTS.AUTH.LOGIN, form)
  ...
  const handleGoogleLogin = () => {
    window.location.href = `${API_ENDPOINTS.BASE_URL}/api/auth/google`
  }
      ...
      <div className="w-full max-w-md">
        <div className="bg-white rounded-2xl shadow-xl p-8 border border-gray-100">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600">Sign in to your StegoSense account</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  onChange={handleChange}
                  required
                  className="w-full px-4 py-3 pr-12 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-colors duration-200"
            ...
            <button
              ...
              disabled={loading}
              className="w-full bg-white border border-gray-300 hover:bg-gray-50 text-gray-700 font-semibold py-3 px-4 rounded-lg transition-colors duration-200 flex items-center justify-center disabled:opacity-50 disabled:cursor-not-allowed"
            >
